...
import '../features/client/presentation/screens/client_other_request_create_screen.dart';
...
import '../features/client/presentation/screens/client_other_request_details_screen.dart';
...
import '../features/admin/presentation/screens/admin_other_requests_screen.dart';
import '../features/admin/presentation/screens/admin_other_request_details_screen.dart';
...
class AppRouter {
  ...
  static const clientCreateMachineRequest = '/client/machine-requests/create';
  static const clientCreateSparePartRequest = '/client/spare-part-requests/create';

  static const clientOrders = '/client/orders';
  static const clientOrderDetails = '/client/orders/details';
  static const clientOtherRequestDetails = '/client/other-requests/details';
  ...
  static const adminMachineRequests = '/admin/machine-requests';
  static const adminSparePartRequests = '/admin/spare-part-requests';
  static const adminOtherRequestDetails = '/admin/other-requests/details';
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case clientCreateMachineRequest:
        return MaterialPageRoute(
          builder: (_) => const ClientOtherRequestCreateScreen(
            requestKind: 'machine_request',
          ),
        );

      case clientCreateSparePartRequest:
        return MaterialPageRoute(
          builder: (_) => const ClientOtherRequestCreateScreen(
            requestKind: 'spare_part_request',
          ),
        );
      ...
      case clientOtherRequestDetails:
        return MaterialPageRoute(
          builder: (_) => ClientOtherRequestDetailsScreen(
            requestId: (settings.arguments as int?) ?? 0,
          ),
        );
      ...
      case adminMachineRequests:
        return MaterialPageRoute(
          builder: (_) => const AdminOtherRequestsScreen(
            requestKind: 'machine_request',
          ),
        );

      case adminSparePartRequests:
        return MaterialPageRoute(
          builder: (_) => const AdminOtherRequestsScreen(
            requestKind: 'spare_part_request',
          ),
      ...
      case adminOtherRequestDetails:
        return MaterialPageRoute(
          builder: (_) => AdminOtherRequestDetailsScreen(
            requestId: (settings.arguments as int?) ?? 0,
          ),
        );
