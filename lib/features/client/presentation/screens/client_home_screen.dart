...
class _ClientHomeScreenState extends State<ClientHomeScreen> {
  ...
  Future<void> _openMachineRequestCreate() async {
    final changed =
        await Navigator.pushNamed(context, AppRouter.clientCreateMachineRequest);
    if (changed == true) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('تم إرسال طلب المكن')),
      );
    }
  }

  Future<void> _openSparePartRequestCreate() async {
    ...
    if (changed == true) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('تم إرسال طلب قطع الغيار')),
      );
    }
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 6),
                Text(
                  'اطلب الصيانة أو المكن أو قطع الغيار، تابع الطلبات، راجع الحساب، وتابع الإشعارات بسهولة.',
          ...
          GridView.count(
            ...
            children: [
              ...
              _MenuCard(
                ...
                title: 'طلب مكن',
                subtitle: 'طلب ماكينة غير موجودة',
                onTap: _openMachineRequestCreate,
              ),
              _MenuCard(
                icon: Icons.settings_suggest_outlined,
                title: 'طلب قطع غيار',
                subtitle: 'طلب قطعة غير موجودة',
                onTap: _openSparePartRequestCreate,
              ),
              _MenuCard(
                icon: Icons.receipt_long_outlined,
                title: 'طلباتي',
                subtitle: 'صيانة + مكن + قطع غيار',
                onTap: _openOrders,
              ),
              _MenuCard(
